...
const Footer=()=>{
    return(
        ...
        <div className='footer_div'>
            ...
            <p className="Footer_features">Help</p>
            <p className="Footer_features">Profile</p>
            <p className="Footer_features">Contact us</p>
            <p className="Footer_features">Home</p>
            <p className="Footer_features">Services</p>
            </div>
