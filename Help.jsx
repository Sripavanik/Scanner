...
import flower from '../assets/flower.mp4'; // Not used, you can remove this line
import helpImage from '../assets/Rectangle 55.png'; // Importing the help image correctly

const Help = () => {
    return (
        <>
        <video src={flower} autoPlay loop muted style={{ filter: 'brightness(30%)' }} className="helpvedio"/>
